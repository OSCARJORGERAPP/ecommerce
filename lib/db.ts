...
// AGENTS.md §Convenciones y RETROSPECTIVA §lecciones heredadas).
// En dev, el singleton vive en globalThis para sobrevivir al hot-reload.
...
export async function getDb(): Promise<Db> {
  ...
  return client.db(process.env.MONGO_DB ?? "ecommerce");
}
